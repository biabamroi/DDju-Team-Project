...
var url = 'https://apis.data.go.kr/B552584/ArpltnStatsSvc/getCtprvnMesureSidoLIst'; /*URL*/ 
        ...
        if(responsData.response.body.items) {
          ...
          for(let i = 0; i < items.length; i++) {
            ...
            if(item.cityName == '유성구') {
             // cityName이 '유성구'인 것 중에 dataTime 가장 최근 데이터 가져오기
              ...
              if(item.pm10Value >= 20) {
               dustItem.innerHTML = '미세먼지 나쁨 <i class="fa-regular fa-face-frown"></i>';
                ...
                dustItem.innerHTML = '미세먼지 좋음 <i class="fa-regular fa-face-smile"></i>';
              }
            }
          }
        }
