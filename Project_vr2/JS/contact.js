let profile = [
  ...
  },
  {
    ...
    name : 'JIEUN KO',
    txt : '안녕하세요! 저는 디디쥬에서 section3, today, contact, 코스대전, api를 맡아서 작업을 했습니다. 초반 기획부터 팀원들과 맡은 부분에 프로젝트를 했습니다. 프로젝트 특성상 기간도 짧지만 노션에 팀과 나눠서 할 코드도 올려보고 특히 깃허브에서 머지를 할 때 부분에 대해 충돌 한번 나고서는 그 후로 서로 게속 카톡로 수시로 대화도 했습니다. 일찍 나와서 회의도 하고 코드도 짜면서 기능 구현을 했습니다. 프로젝트를 하면서 어려웠던 부분이라면 수업시간에 배운걸로 코드를 짜서 완성을 하고 회의를 할 때 보면 기능을 더 추가하는 방법은 어떤지도 의견을 받고 디자인 변동도 많아서 수업시간외에 구글링으로 배운공부들도 있었기 때문에 오히려 공부하는데 더 도움이 되었습니다. 팀프로젝트를 하면서 가장 많이 성장할수 있는 부분인거 같습니다. 다같이 부족한 부분 오류도 생겨서 잡고 같이 구현하면서 시간도 보냈습니다. 팀원들과 원할게 소통도 잘되어서 너무 좋았습니다!! ',
